...
const panduan = [
  ...
  },
  {
    ...
    items: [
      ...
      "Form import: gunakan koma sebagai pemisah kolom, dan pastikan kolom nama kelas sesuai data kelas yang sudah ada.",
    ],
  },
  {
    id: "data-kelas",
    ...
    items: [
      ...
      "Nama kelas disarankan konsisten dengan data siswa agar import CSV mengenali kelas dengan benar.",
    ],
  },
  {
    id: "jadwal-mengajar",
    ...
    items: [
      ...
      "Gunakan format jam 24 angka (mis. 07.30) pada kolom Jam Mulai/Selesai.",
    ],
  },
  {
    id: "absensi",
    ...
    items: [
      ...
      "Rekap otomatis ada di menu Rekap Absensi (cetak presensi juga tersedia).",
    ],
  },
  {
    id: "nilai",
    ...
    items: [
      ...
      "Nilai tersedia di paket Pro. Paket gratis belum dapat mengakses nilai.",
  ...
  },
  {
    ...
    items: [
      ...
      "Data jurnal bisa di-generate ke LCKH (paket Premium).",
      "Isi kolom Materi & Deskripsi dengan jelas agar laporan LCKH informatif.",
    ],
  },
  {
    id: "lainnya",
    ...
    items: [
      ...
      "Rekap Nilai: Lihat perbandingan nilai siswa per bab (paket Pro).",
      "Kelompok Belajar: Kelompokkan siswa untuk aktivitas belajar kelompok (paket Pro).",
      "Kalender: Lihat jadwal, absensi, dan catatan harian dalam tampilan kalender.",
      "LCKH/LKB: Generate laporan catatan kegiatan harian dan laporan kinerja bulanan (paket Premium).",
      "Template Surat: Download template surat panggilan, keterangan aktif belajar, dan tugas/PR.",
    ],
  },
  {
    id: "akun-pengaturan",
    judul: "Akun & Pengaturan",
    icon: "fa-user-cog",
    color: "text-[#0D7C66]",
    bg: "bg-[#eefbf8]",
    items: [
      "Profil Sekolah: isi nama sekolah, NPSN, NIP/Nama guru, dan logo URL agar kop surat terisi otomatis.",
      "Pengaturan: ubah nama aplikasi, tahun ajaran, semester, dan KKM default. Hanya admin yang dapat mengubah ini.",
      "Akun: ganti nama lengkap, password, dan foto profil lewat menu avatar di pojok kanan atas.",
      "Berikan kolom wajib (NPSN, NIP) agar dokumen resmi tidak kosong.",
    ],
  },
];
    ...
    <div className="p-6 fade-in">
      ...
      <div className="max-w-3xl">
        ...
        <div className="space-y-4">
          {panduan.map((p) => (
            <div key={p.judul} id={p.id} className="card">
