const faqs = [
  {
    ...
    a: "Ya. Akun baru mendapat masa percobaan gratis 2 hari untuk mencoba seluruh fitur. Setelah itu Anda bisa terus memakai fitur dasar (dashboard, data siswa/kelas, absensi, rekap & cetak presensi, jurnal mengajar, kalender, dan surat) atau upgrade ke Pro/Premium untuk fitur lengkap.",
  },
  {
    q: "Apa bedanya paket Gratis, Pro, dan Premium?",
    a: "Gratis: fitur dasar presensi & jurnal, masa aktif 2 hari untuk akun baru. Pro (Rp 29.000 / 6 bulan): gratis + nilai, rekap nilai, dan generate kelompok belajar. Premium (Rp 49.000 / 6 bulan, akses semua): semua fitur Pro + generate LCKH dan LKB bagi pegawai.",
  },
  {
