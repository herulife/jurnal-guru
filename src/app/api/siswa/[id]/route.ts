...
export async function PUT(
  ...
  try {
    ...
    await db.update(dataSiswa).set(updateData).where(eq(dataSiswa.id, id));
    await addLog(session.id, "UPDATE_SISWA", `Update siswa ${id}`);
    return apiOk(null, "Siswa diperbarui");
  } catch (e: unknown) {
